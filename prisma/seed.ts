...
async function main() {
  ...
  console.log("  admin      /admin/login       sa.admin      Adm#2026Temp");
  console.log("  records    /records/login     rec.1001      Rec#2026Temp");
  console.log("  intern     /intern/login      int.fahad     Int#2026Temp");
  console.log("  student    /student/login     443012345     Std#2026Temp");
  console.log("  supervisor /supervisor/login  sup.2001      Sup#2026Temp");
  void admin;
}
